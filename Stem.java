...
This code is modified by Dafne van Kuppevelt
*/
...
public class Stem
{
    ...
    public Stem(File fileToBeStemmed, Vector statFiles){
    	this(fileToBeStemmed, statFiles, "UTF-16");
    }
    // constructor
    public Stem ( File fileToBeStemmed, Vector statFiles , String encoding)
    {
    ...
    private void readFromFile ( File currentFile )
    {
        try {
            ...
            InputStreamReader str = new InputStreamReader ( in, this.encoding );
